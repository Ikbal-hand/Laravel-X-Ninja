        ...
        <div class="mx-auto max-w-7xl px-72 sm:px-6 lg:px-8 flex flex-end" >
            <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 md:gap-8 py-10 max-sm:max-w-sm max-sm:mx-auto gap-y-8">
                <div class="col-span-full mb-10 lg:col-span-2 lg:mb-0">
                    <a href="/"  class="flex justify-center lg:justify-start">
                        <h1 class="font-bold">STT CIPASUNG</h1>
                    </a>
                    ...
                    <a href="javascript:;"  class="btn btn-sttc ">
                        Contact us
                    </a>
                </div>
                <div class="lg:mx-auto text-left ">
                    <h4 class="text-lg text-gray-900 font-medium mb-7">Jurusan</h4>
                    <ul class="text-sm  transition-all duration-500">
                        <li class="mb-6"><a href="javascript:;"  class="text-gray-600 hover:text-gray-900">Teknik informatika</a></li>
                        <li class="mb-6"><a href="javascript:;"  class=" text-gray-600 hover:text-gray-900">Teknik Industri</a></li>
                    </ul>
                </div>
                <!--End Col-->
                <div class="lg:mx-auto text-left">
                    ...
                    <ul class="text-sm  transition-all duration-500">
                        ...
                        <li class="mb-6"><a href="/login"  class=" text-gray-600 hover:text-gray-900">Login as Administrator</a></li>
                    </ul>
                </div>
                <!--End Col-->
                <div class="lg:mx-auto text-left">
            ...
            <div class="py-7 border-t border-gray-200">
                <div class="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                    <span class="text-sm text-gray-500 ">©<a href="/">Ninja-Turtle-Project</a> 2024, All rights reserved.</span>
