    ...
    <div class="mx-auto max-w-7xl px-72 sm:px-6 lg:px-8 flex flex-end">
        <div
            ...
            <div class="col-span-full mb-10 lg:col-span-2 lg:mb-0">
                ...
                <p class="py-8 text-sm text-gray-500 lg:max-w-xs text-center lg:text-left">Menuju Tak terbatas dan
                    melampauinya 🔥</p>
            ...
            <div class="lg:mx-auto text-left ">
                ...
                <ul class="text-sm  transition-all duration-500">
                    <li class="mb-6"><a href="javascript:;" class="text-gray-600 hover:text-gray-900">Teknik
                            informatika</a></li>
                    <li class="mb-6"><a href="javascript:;" class=" text-gray-600 hover:text-gray-900">Teknik
                            Industri</a></li>
                </ul>
            ...
            <div class="lg:mx-auto text-left">
                ...
                <ul class="text-sm  transition-all duration-500">
                    ...
                    <li class="mb-6"><a href="javascript:;" class=" text-gray-600 hover:text-gray-900">Mahasiswa
                            Help</a></li>
                    <li class="mb-6"><a href="/login" class=" text-gray-600 hover:text-gray-900">Login as
                            Administrator</a></li>
