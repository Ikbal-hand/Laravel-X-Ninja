<x-layouts.app>
    ...
    <div class="container mx-auto py-8 flex justify-center">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 mb-12 justify-center">
    ...
    <div class="bg-white p-5 flex items-center">
        <div class="w-1/5 flex justify-center">
            <img class="rounded-full w-32 h-32"
                src="https://png.pngtree.com/png-clipart/20230207/ourmid/pngtree-megawati-soekarno-daughter-of-the-president-of-the-republic-of-indonesia-png-image_6590527.png"
                alt="Alumni Image">
        </div>
        ...
        <div class="w-4/5">
            ...
            <p class="text-gray-600 mt-4">
                Sekolah Tinggi Teknologi Cipasung adalah tempat yang mengubah cara pandang saya tentang teknologi dan
                masa depan. Dengan dosen-dosen yang berdedikasi, lingkungan belajar yang mendukung, dan teman-teman yang
                luar biasa, saya merasa benar-benar siap menghadapi tantangan dunia kerja.
            </p>
        </div>
    </div>
    ...
    <div class="bg-white p-5 flex items-center">
        ...
        <div class="w-4/5">
            ...
            <p class="text-gray-600 mt-4">
                Belajar di Sekolah Tinggi Teknologi Cipasung memberikan saya bekal yang lebih dari sekadar teori. Kampus
                ini mengajarkan pentingnya inovasi, kerja keras, dan kolaborasi. Saya bangga menjadi bagian dari
                keluarga besar Cipasung.
            </p>
        </div>
    </div>
    ...
    <div class="bg-white p-5 flex items-center">
        <div class="w-1/5 flex justify-center">
            <img class="rounded-full w-32 h-32"
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTQqRUf_cuSmqtZ0_g53INgfRYQTGduOQePwA&s"
                alt="Alumni Image">
        </div>
        ...
        <div class="w-4/5">
            ...
            <h5 class="text-gray-600">Teknik Informatika, Angkatan 2020</h5>
            <p class="text-gray-600 mt-4">
                Sekolah Tinggi Teknologi Cipasung bukan hanya tempat belajar, tetapi juga tempat saya menemukan potensi
                diri. Ilmu yang saya dapatkan di sini terus menjadi bekal untuk berkontribusi dalam dunia teknologi dan
                masyarakat.
            </p>
        </div>
    </div>
