<nav class="sticky top-0 z-50 bg-white linear-gradient py-2 ">
    <div class="">
        ...
        <div class="flex items-center space-x-4">
            ...
            <x-nav-link href="/kehidupan-kampus" class="{{request()->is('kehidupan-kampus')? 'bg-green-700 text-white py-2 px-2' : 'bg-white py-2 px-2 hover:bg-yellow-200 relative'}}  rounded-lg"> Beranda </x-nav-link>
